...
class Phase9ExperimentTests(unittest.TestCase):
    ...
    def test_phase9_cockpit_ui_selectors_and_strings_exist(self) -> None:
        ...
        for element_id in [
            ...
            "copyPhase9ReplayValidationJson",
            "expandPhase9ValidationGroups",
            "collapsePhase9ValidationGroups",
            "expandPhase9ReplayValidationGroups",
            "collapsePhase9ReplayValidationGroups",
            "clearPhase9Bundle",
            "phase9ReplayStatus",
            "phase9ReplayErrors",
        ...
        for visible_label in [
            ...
            "Copy replay validation JSON",
            "Expand validation",
            "Collapse validation",
            "Expand replay validation",
            "Collapse replay validation",
    ...
    def test_phase9_cockpit_bundle_import_replay_hooks_exist(self) -> None:
        ...
        for function_name in [
            ...
            "renderPhase9ReplayValidationHealthStrip",
            ...
            "copyPhase9ValidationSummaryPayload",
            "copyPhase9ValidationErrorsPayload",
            "copyPhase9DebugFocusPayload",
            "copyPhase9ReplayValidationJsonPayload",
        ...
        for required_string in [
            ...
            "phase9ReplayValidationHealthStrip",
            "validation_summary",
            "validation_errors",
            "debug_focus",
            "validation_json",
        ...
        for css_selector in [
            ...
            ".phase9-replay-copy-actions",
            ".phase9-replay-validation-health-strip",
